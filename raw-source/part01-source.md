...
Notice that all we do here is compute a new value for `min`, and that it will always end up being a `Number` rather than `Nothing`. In Rust, the structure of the code can express this.
